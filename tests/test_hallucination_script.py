...
pytestmark = pytest.mark.skip(reason="Test script with hallucinations for validation testing")

# Test script with known hallucinations - wrapped in function to avoid execution during import
