...
class TestSimpleIntegration:
    ...
    def mock_embedding(self):
        ...
        with patch("utils.create_embedding", side_effect=_mock_embedding):
            with patch(
    ...
    async def test_code_examples_integration(self, mock_embedding):
        ...
        mock_db.search_code_examples = AsyncMock(
            return_value=[
                {
                    "id": "1",
    ...
    async def test_contextual_embeddings_flag(self, mock_embedding):
        ...
        with patch(
            "utils.generate_contextual_embedding",
            ...
            await add_documents_to_database(
                ...
                url_to_full_document={
                    "https://example.com/doc2": "Full document content 2",
                },
            )
